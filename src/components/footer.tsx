      ...
      <div className="flex flex-col md:flex-row justify-between m-2.5 pb-5 gap-6 md:gap-0">
        <div className="w-full md:w-3/5 max-w-[580px]">
          ...
          <p className="text-sm p-2.5">
            As a skilled full-stack web developer, I expertly craft both the frontend and backend of websites and web
            applications, guaranteeing smooth integration that enhances the overall product's success and user
            experience.
          </p>
        </div>
