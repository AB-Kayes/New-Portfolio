    ...
    <div className="my-auto">
      ...
      <ul className="hidden items-center sm:flex">
        {navLinks.map((navLink, index) => (          
          <a key={index} href={navLink.link} className="text-black/0 h-full items-center"><li  className="flex items-center font-bold uppercase rounded-md p-4 text-black h-full duration-300 hover:text-pink-500 hover:bg-gray-200 active:text-pink-700 active:bg-gray-300"><span>{navLink.title}</span> </li></a>
        ))}
      </ul>
  </nav>
